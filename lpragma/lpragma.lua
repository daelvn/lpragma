...
return function(ast)
  ...
  ast = (actorReplace(Pragma("IndexableStrings")))(IndexableStrings)
  ast = (actorReplace(Pragma("Substrings")))(Substrings)
  ast = (actorReplace(Pragma("PowerMetatables")))(PowerMetatables)
  return ast
end
